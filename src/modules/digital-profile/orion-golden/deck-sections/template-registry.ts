...
> = {
  ...
  "regional-summary": [
    ...
    },
    {
      id: "dense-themes",
      description:
        "C7 — плотная раскладка тематических блоков при большом объёме: меньше пустоты, продолжения несут целые темы без клипа соседа.",
    },
  ],
  "executive-summary": [
    {
      id: "dense-themes",
      description:
        "C7 — уплотнённые карточки ключевых тем, когда на странице много блоков и риск пустоты при переполнении соседа.",
    },
  ],
};
