    ...
    const deck = await runDeckGptCopyRetry({
      ctx: {
        ...
        extras: {
          ...
          composedClientSummary: deckInputs.composedClientSummary,
          canonicalClaims: deckInputs.canonicalClaims,
          itemAnalysisBundle: deckInputs.itemAnalysisBundle,
          sourceTextByEvidenceRef: deckInputs.sourceTextByEvidenceRef,
          excludeEvidenceRefs: deckInputs.excludeEvidenceRefs,
          ...deckFreshnessExtras,
        },
      },
