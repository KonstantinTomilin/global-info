...
async function stepPrepare(
  ...
  try {
    ...
    const isClientSummaryGateFailure =
      /SUMMARY_INCOMPLETE_SENTENCES|SUMMARY_TECHNICAL_COPY_TOKENS|SUMMARY_MATERIAL_THEME_COVERAGE|SUMMARY_CONCRETE_EXAMPLES|SUMMARY_UNSUPPORTED_ASSERTIONS|PER_THEME_WHY_IS_ARTICLE_SPECIFIC|CLIENT_INCOMPLETE_SENTENCES|CLIENT_TEXT_TRUNCATIONS|CLIENT_TECHNICAL_TOKENS|CROSS_SLIDE_DUPLICATE|MATERIALS_WITH_MULTIPLE_FULL_DISCLOSURES|CONCRETE_EXAMPLE_STRUCTURE|UNGROUNDED_CLIENT|JUNK_ADVERSE/i.test(
        message
      );
